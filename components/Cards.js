      ...
      <div className="p-11 flex flex-col gap-6 w-max h-[510px] rounded-lg border border-[#E4E4E7] backdrop-blur-sm">
        ...
        <h1 className="font-bold text-5xl text-[#27272a]">
          {price} <span className="font-bold text-base">/month</span>
            ...
            <div className="flex flex-col gap-6 font-normal text-sm">{children}</div>
       
        <Link href="" className= {`flex items-center justify-center w-full h-10 rounded-3xl py-3 px-4 border ${bgColor} ${textColor} `}>
          {buttonTag}
        </Link>
      </div>
    </>
